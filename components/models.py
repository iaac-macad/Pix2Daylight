...
def Discriminator():
  ...
  inp = tf.keras.layers.Input(shape=[512, 512, 4], name='input_image')  # Change to 4 channels for RGBA
  tar = tf.keras.layers.Input(shape=[512, 512, 4], name='target_image')  # Change to 4 channels for RGBA
